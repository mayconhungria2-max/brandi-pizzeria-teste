  ...
  return (
    <header className="sticky top-0 z-40 border-b border-border bg-cream/85 backdrop-blur-xl">
      <div className="mx-auto grid max-w-[1400px] grid-cols-[auto_1fr] items-center gap-6 px-4 py-2 lg:gap-10 lg:px-8 lg:py-3">
        ...
        >
          <span className="block overflow-hidden rounded-2xl ring-1 ring-forest/15 shadow-[0_10px_24px_rgba(0,0,0,0.14)] lg:rounded-3xl">
            <img
              src={logoAsset.url}
              alt="Brandi Pizzerie"
              width={640}
              height={640}
              className="block h-16 w-16 object-cover sm:h-20 sm:w-20 lg:h-24 lg:w-24"
            />
          </span>
        </a>
